...
const FIELD_LABELS: Record<string, string> = {
	...
	'plugins.stealth.chromium.user_agent': 'User-Agent (chromium)',
	'plugins.stealth.chromium.headless': 'ヘッドレス',
	'plugins.stealth.chromium.hide_automation': '自動化フラグを隠す',
	'plugins.stealth.chromium.disable_gpu': 'GPU 無効化',
	'plugins.stealth.chromium.user_data_dir': 'ユーザーデータディレクトリ',
	'plugins.stealth.chromium.lang': 'ブラウザ言語',
	'plugins.stealth.chromium.window_width': 'ウィンドウ幅',
	'plugins.stealth.chromium.window_height': 'ウィンドウ高さ',
	'plugins.stealth.chromium.accept_language': 'Accept-Language (chromium)',
	'output.dir': '出力フォルダ',
