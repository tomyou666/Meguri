export const messages = {
	...
	nodeTree: {
		...
		copyUrl: 'URL をコピー',
		openMenu: 'ノードメニュー',
		noMatches: '一致するノードがありません',
	},
	right: {
		runSummary: '実行サマリ',
		nodeResult: 'ノード結果',
		nodeSettings: 'ノード設定',
		createNodeSettings: '設定を作成する',
	...
	dialog: {
		...
		deleteNodeSettingsTitle: 'ノード設定の削除',
		deleteNodeSettingsConfirm: 'このノードの個別設定を削除しますか？',
		...
		duplicateWorkspaceMode: 'コピー内容',
		duplicateWorkspaceModeFull: '設定とノード構成',
		duplicateWorkspaceModeSettings: '設定のみ',
		duplicateWorkspaceUrl: '起点 URL',
		renameWorkspaceTitle: 'ワークスペース名を変更',
		renameWorkspaceName: '名前',
		renameWorkspaceSuccess: 'ワークスペース名を変更しました',
		cancel: 'キャンセル',
		create: '作成',
		copy: 'コピー',
		add: '追加',
	...
	settings: {
		...
		help: {
			...
			wait_after_load:
				'wait_until=load 成功後、SPA等のレンダリング完了を待つための追加待機時間。wait_timeout とは独立に必ず待機します（0 なら追加待機なし）。',
