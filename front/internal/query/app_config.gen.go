...
func newAppConfig(db *gorm.DB, opts ...gen.DOOption) appConfig {
	...
	_appConfig.ID = field.NewInt32(tableName, "id")
	_appConfig.DefaultsJSON = field.NewString(tableName, "defaults_json")
	_appConfig.UpdatedAt = field.NewString(tableName, "updated_at")
...
func (a *appConfig) updateTableName(table string) *appConfig {
	...
	a.DefaultsJSON = field.NewString(table, "defaults_json")
...
func (a *appConfig) WithContext(ctx context.Context) IAppConfigDo {
	return a.appConfigDo.WithContext(ctx)
}

func (a appConfig) TableName() string { return a.appConfigDo.TableName() }

func (a appConfig) Alias() string { return a.appConfigDo.Alias() }

func (a appConfig) Columns(cols ...field.Expr) gen.Columns { return a.appConfigDo.Columns(cols...) }
...
func (a *appConfig) fillFieldMap() {
	...
	a.fieldMap["id"] = a.ID
	a.fieldMap["defaults_json"] = a.DefaultsJSON
