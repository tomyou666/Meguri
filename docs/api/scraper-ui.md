...
| `SaveWorkspaceSettings` | `PUT /api/v1/workspaces/{id}/settings` | WS 既定（request/content/pdf/crawl/plugins） |
...
| `DeleteResults` | `DELETE /api/v1/workspaces/{wsId}/results` | 削除 |
...
| `SaveResultsSnapshot` | `POST /api/v1/workspaces/{wsId}/snapshot` | baseline_run 更新 |
